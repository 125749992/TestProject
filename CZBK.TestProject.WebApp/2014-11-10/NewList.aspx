<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewList.aspx.cs" Inherits="CZBK.TestProject.WebApp._2014_11_10.NewList" %>
<%@ Import Namespace="CZBK.TestProject.Common" %>
...
<!----------------------------------end header_column---------------------------------->
	  ...
	  <div id="main_column">
        ...
        <dl class="menu_prd">
            ...
            <a href="WebDemos/Contact/Contact.html" class="contct"><img src="WebDemos/images/img_contact_sidebarcolumn.png" width="160" height="52" alt="联系我们" /></a><!-- #EndLibraryItem --></div>
      	<div id="content_column">
            ...
            <div class="cont">
                ...
                <div class="pages">
                   ...
                   首页  | 前页 | 
                    <%}else{ %>
                   <a href="NewList.aspx?pageIndex=1"> 首页</a>  | <a href="NewList.aspx?pageIndex=<%=PageIndex<=1?1:PageIndex-1 %>"> 前页</a>  | 
                    <%} %>

                     <a href="NewList.aspx?pageIndex=<%=PageIndex>=PageCount?PageCount:PageIndex+1%>"> 后页</a> |  <a href="NewList.aspx?pageIndex=<%=PageCount %>"> 尾页 </a>        页次：1/3页 
                    <hr />
                    <p class="page_nav">
